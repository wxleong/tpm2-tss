...
#else
    TPM2_CAP_VENDOR_PROPERTY, ADDR, ifxProperty, Tss2_MU_TPML_TAGGED_IFX_PROPERTY_Marshal)
#endif
...
#else
    TPM2_CAP_VENDOR_PROPERTY, ifxProperty, Tss2_MU_TPML_TAGGED_IFX_PROPERTY_Unmarshal)
#endif
