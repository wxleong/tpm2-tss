...
TPML_MARSHAL(TPML_TAGGED_IFX_PROPERTY, Tss2_MU_TPMS_TAGGED_PROPERTY_Marshal, ifxProperty, ADDR)
TPML_UNMARSHAL(TPML_TAGGED_IFX_PROPERTY, Tss2_MU_TPMS_TAGGED_PROPERTY_Unmarshal, ifxProperty)
